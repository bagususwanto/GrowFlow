  ...
  const handleConfirm = React.useCallback(
    async (gr: { id: string; number: string }) => {
      const ok = await confirm({
        ...
        description: `Confirm receipt for GRN ${gr.number}? This will add items to stock balance and cannot be undone.`,
  ...
  const handleDelete = React.useCallback(
    async (gr: { id: string; number: string }) => {
      const ok = await confirm({
        ...
        description: `Are you sure you want to delete draft GRN ${gr.number}? This action cannot be undone.`,
        confirmText: 'Delete',
        variant: 'destructive',
      });
      if (ok) {
