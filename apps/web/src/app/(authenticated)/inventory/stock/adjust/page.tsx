...
export default function StockAdjustPage() {
  ...
  const handleAdjustSubmit = async (data: { itemId: string; warehouseId: string; qty: number; note?: string }) => {
    toast.promise(
      adjustStockMutation.mutateAsync(data),
      {
    ...
    <div className="space-y-6 px-4 lg:px-6 max-w-2xl">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-0.5">
          <h1 className="font-bold text-foreground text-2xl tracking-tight">Manual Stock Adjustment</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Use this form only for corrections, disposals, or direct manual updates. For purchases or sales, please use proper documents.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <StockAdjustForm
